    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">  
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">  
            ...
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">  
                ...
                <li>  
                    <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Photos</a>  
                </li>  
                <li>  
                ...
                <li class="md:hidden border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">  
                    <div class="flex items-center px-4 py-2 space-x-3">  
                        <img class="w-10 h-10 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-3.jpg" alt="user photo">  
                        <div>  
                            <span class="block text-sm text-gray-900 dark:text-white">Bonnie Green</span>  
                            <span class="block text-sm text-gray-500 truncate dark:text-gray-400">bonnie@flowbite.com</span>  
                        </div>  
                ...
                <li class="md:hidden">  
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">photos</a>  
                </li>  
                <li class="md:hidden">  
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">profile</a>  
                </li>  
...
<section class="bg-gray-500 min-h-[800px] flex items-center justify-center p-4">
    <div class="bg-gray-100 flex flex-col sm:flex-row rounded-2xl shadow-lg max-w-5xl w-full p-5">
        <div class="w-full sm:w-1/2 flex flex-col items-center order-1 sm:order-none relative">
            <!-- Esthetic Delete Button -->
            <button class="absolute top-4 right-4 text-white bg-red-500 hover:bg-red-600 p-2 rounded-full transition-transform transform hover:scale-110 shadow-md focus:outline-none">
        ...
        <div class="w-full sm:w-1/2 px-8 flex flex-col justify-between order-2 sm:order-none md:mt-[0px] mt-5">
            <div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-700 mb-2">A day at the museum - a perfect New York activity...</p>
